...
ACTION_METADATA: dict[str, dict[str, str]] = {
    ...
    "require_confirmation": {"label": "要求显式确认", "kind": "safety", "priority": "high"},
    "show_plan_summary": {"label": "展示执行计划摘要", "kind": "safety", "priority": "high"},
    "verify_polarity": {"label": "确认极性和夹具方向", "kind": "safety", "priority": "high"},
    ...
    "decline_fake_result": {"label": "拒绝编造测量值", "kind": "safety", "priority": "high"},
    "suggest_simulation": {"label": "建议改用仿真或离线数据", "kind": "execute", "priority": "medium"},
